...
describe("should return false when endpoint does not match", () => {
  ...
  it("different interval", () => {
    ...
    existing.spec.endpoints = [generateEndpoint({ interval: "old" })];
  ...
  it("different port", () => {
    ...
    existing.spec.endpoints = [generateEndpoint({ port: "old" })];
  ...
  it("different path", () => {
    ...
    existing.spec.endpoints = [generateEndpoint({ path: "old" })];
