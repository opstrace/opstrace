...
export class V1Alpha2ClusterissuerApi {
  ...
  public setApiKey(key: V1Alpha2ClusterissuerApiApiKeys, value: string) {
    (this.authentications as any)[
      V1Alpha2ClusterissuerApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async createNamespacedV1Alpha2Clusterissuer(
    namespace: string,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Alpha2Clusterissuer }> {
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1alpha2/clusterissuers".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Alpha2Clusterissuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Alpha2Clusterissuer."
      );
    }
   ...
   */
  public async readNamespacedV1Alpha2Clusterissuer(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1alpha2/clusterissuers/{name}"
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Alpha2Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Alpha2Clusterissuer."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Alpha2Clusterissuer(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Alpha2Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Alpha2Clusterissuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Alpha2Clusterissuer."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Alpha2Clusterissuer(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Alpha2Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Alpha2Clusterissuer."
      );
    }
  ...
  public async listV1Alpha2ClusterissuerForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Alpha2ClusterissuerList }> {
    const localVarPath =
      this.basePath + "/apis/cert-manager.io/v1alpha2/clusterissuers";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Alpha2ClusterissuerResource = <
  (r: K8sResource) => r is V1Alpha2ClusterissuerResourceType
...
export const V1Alpha2ClusterissuerActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1ALPHA2CLUSTERISSUER"
  )<V1Alpha2ClusterissuerResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1ALPHA2CLUSTERISSUER"
  )<V1Alpha2ClusterissuerResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1ALPHA2CLUSTERISSUER"
  )<V1Alpha2ClusterissuerResourceType>()
};
export type V1Alpha2ClusterissuerResourceActions = ActionType<
  typeof V1Alpha2ClusterissuerActions
>;
export interface V1Alpha2ClusterissuerResourceState
  extends ResourceCache<V1Alpha2ClusterissuerResourceType> {}
...
>(initialState)
  ...
  .handleAction(
    [
      V1Alpha2ClusterissuerActions.onUpdated,
      V1Alpha2ClusterissuerActions.onAdded
    ],
    (state, action): V1Alpha2ClusterissuerResourceState => ({
      ...state,
      resources: [
...
export class V1Alpha2ClusterissuerResource extends K8sResource {
        ...
        channel(
          V1Alpha2ClusterissuerActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Alpha2ClusterissuerResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Alpha2Clusterissuer) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Alpha2ClusterissuerActions.onAdded(
                new V1Alpha2ClusterissuerResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Alpha2Clusterissuer(
      this.namespace,
      this.resource
    );
  }
  read(): Promise<{
    ...
    return this.api.readNamespacedV1Alpha2Clusterissuer(
      this.name,
      this.namespace
    );
  }
  ...
  delete(): Promise<{
    ...
    return this.api.deleteNamespacedV1Alpha2Clusterissuer(
      this.name,
      this.namespace
    );
  }
