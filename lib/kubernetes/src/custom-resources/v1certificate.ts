...
export class V1CertificateApi {
   ...
   */  
  public async createNamespacedV1Certificate (namespace: string, body: V1Certificate, includeUninitialized?: boolean, pretty?: string, dryRun?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Certificate;  }> {
    ...
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling createNamespacedV1Certificate.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
        throw new Error('Required parameter body was null or undefined when calling createNamespacedV1Certificate.');
    }
    ...
    return authenticationPromise.then(() => {
        ...
        return new Promise<{ response: IncomingMessage; body: V1Certificate;  }>((resolve, reject) => {
   ...
   */
  public async readNamespacedV1Certificate (name: string, namespace: string, pretty?: string, exact?: boolean, _export?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Certificate;  }> {
    ...
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling readNamespacedV1Certificate.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling readNamespacedV1Certificate.');
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Certificate (name: string, namespace: string, body: object, pretty?: string, dryRun?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Certificate;  }> {
    const localVarPath = this.basePath + '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}'
        .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
        .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    let localVarQueryParameters: any = {};
    ...
    // verify required parameter 'name' is not null or undefined
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling patchNamespacedV1Certificate.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling patchNamespacedV1Certificate.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
        throw new Error('Required parameter body was null or undefined when calling patchNamespacedV1Certificate.');
    }
   ...
   * @param body 
   */  
  public async deleteNamespacedV1Certificate (name: string, namespace: string, pretty?: string, dryRun?: string, gracePeriodSeconds?: number, orphanDependents?: boolean, propagationPolicy?: string, body?: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Status;  }> {
    const localVarPath = this.basePath + '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}'
        .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
        .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    let localVarQueryParameters: any = {};
    ...
    // verify required parameter 'name' is not null or undefined
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling deleteNamespacedV1Certificate.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling deleteNamespacedV1Certificate.');
    }
   ...
   */
  public async listV1CertificateForAllNamespaces (allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, timeoutSeconds?: number, watch?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1CertificateList;  }> {
      ...
      return authenticationPromise.then(() => {
          ...
          return new Promise<{ response: IncomingMessage; body: V1CertificateList;  }>((resolve, reject) => {
              localVarRequest(localVarRequestOptions, (error, response, body) => {
                  if (error) {
                      reject(error);
                  } else {
...
export const isV1CertificateResource = <(r: K8sResource) => r is V1CertificateResourceType>(
...
export const V1CertificateActions = {
  ...
  onUpdated: createAction("ON_UPDATED_K8S_V1CERTIFICATE")<V1CertificateResourceType>(),
  onAdded: createAction("ON_ADDED_K8S_V1CERTIFICATE")<V1CertificateResourceType>(),
  onDestroyed: createAction("ON_DESTROYED_K8S_V1CERTIFICATE")<V1CertificateResourceType>()
};
export type V1CertificateResourceActions = ActionType<typeof V1CertificateActions>;
export interface V1CertificateResourceState extends ResourceCache<V1CertificateResourceType> {}
...
export class V1CertificateResource extends K8sResource {
  ...
  static startInformer(
    ...
    const watch = async () => {
      ...
      try {
        ...
        channel(
          V1CertificateActions.fetch.success({
            resources: res.body.items.map(r => new V1CertificateResource(r, kubeConfig))
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Certificate) => {
        switch (phase) {
          case "ADDED":
            channel(V1CertificateActions.onAdded(new V1CertificateResource(obj, kubeConfig)));
            break;
          case "MODIFIED":
            channel(V1CertificateActions.onUpdated(new V1CertificateResource(obj, kubeConfig)));
            break;
          case "DELETED":
            channel(
              V1CertificateActions.onDestroyed(new V1CertificateResource(obj, kubeConfig))
            );
            break;
        }
      };
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Certificate(this.namespace, this.resource)
