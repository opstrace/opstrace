...
export class V1Alpha3OrderApi {
   ...
   */
  public async createNamespacedV1Alpha3Order(
    namespace: string,
    body: V1Alpha3Order,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Alpha3Order }> {
    const localVarPath =
      this.basePath +
      "/apis/acme.cert-manager.io/v1alpha3/namespaces/{namespace}/orders".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Alpha3Order."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Alpha3Order."
      );
    }
    ...
    return authenticationPromise.then(() => {
      ...
      return new Promise<{ response: IncomingMessage; body: V1Alpha3Order }>(
        (resolve, reject) => {
   ...
   */
  public async readNamespacedV1Alpha3Order(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Alpha3Order."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Alpha3Order."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Alpha3Order(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Alpha3Order."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Alpha3Order."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Alpha3Order."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Alpha3Order(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Alpha3Order."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Alpha3Order."
      );
    }
   ...
   */
  public async listV1Alpha3OrderForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Alpha3OrderList }> {
    const localVarPath =
      this.basePath + "/apis/acme.cert-manager.io/v1alpha3/orders";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Alpha3OrderResource = <
  (r: K8sResource) => r is V1Alpha3OrderResourceType
...
export const V1Alpha3OrderActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1ALPHA3ORDER"
  )<V1Alpha3OrderResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1ALPHA3ORDER"
  )<V1Alpha3OrderResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1ALPHA3ORDER"
  )<V1Alpha3OrderResourceType>()
};
export type V1Alpha3OrderResourceActions = ActionType<
  typeof V1Alpha3OrderActions
>;
export interface V1Alpha3OrderResourceState
  extends ResourceCache<V1Alpha3OrderResourceType> {}
...
export class V1Alpha3OrderResource extends K8sResource {
    ...
    const watch = async () => {
        ...
        channel(
          V1Alpha3OrderActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Alpha3OrderResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Alpha3Order) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Alpha3OrderActions.onAdded(
                new V1Alpha3OrderResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
            channel(
              V1Alpha3OrderActions.onUpdated(
                new V1Alpha3OrderResource(obj, kubeConfig)
              )
            );
            break;
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Alpha3Order(
      this.namespace,
      this.resource
    );
  }
