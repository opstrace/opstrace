 ...
 */
export interface V1Alertmanager {
  /**
...
export class V1AlertmanagerApi {
  ...
  public setApiKey(key: V1AlertmanagerApiApiKeys, value: string) {
    (this.authentications as any)[V1AlertmanagerApiApiKeys[key]].apiKey = value;
  }
  ...
  /**
   * read the specified V1Alertmanager
  ...
  /**
   * list or watch objects of kind V1Alertmanager
...
export const V1AlertmanagerActions = {
  fetch: createAsyncAction(
    "FETCH_K8S_V1ALERTMANAGERS_REQUEST",
...
export const V1AlertmanagerReducer = createReducer<
  V1AlertmanagerResourceState,
  V1AlertmanagerResourceActions
>(initialState)
  .handleAction(
    V1AlertmanagerActions.fetch.request,
    (state, _): V1AlertmanagerResourceState => ({
      ...state,
      loaded: false
    })
  )
  ...
  .handleAction(
    V1AlertmanagerActions.fetch.failure,
    (state, action): V1AlertmanagerResourceState => ({
      ...state,
      ...action.payload,
      loaded: false
  ...
  .handleAction(
    [V1AlertmanagerActions.onUpdated, V1AlertmanagerActions.onAdded],
    (state, action): V1AlertmanagerResourceState => ({
      ...state,
      resources: [
...
export class V1AlertmanagerResource extends K8sResource {
  protected api: V1AlertmanagerApi;
  protected resource: V1Alertmanager;

  constructor(resource: V1Alertmanager, kubeConfig: KubeConfig) {
    super(resource, kubeConfig);

    this.resource = resource;
    this.api = kubeConfig.makeApiClient(V1AlertmanagerApi);
  }
  get spec(): V1Alertmanager {
  ...
  static startInformer(
    ...
    const client = kubeConfig.makeApiClient(V1AlertmanagerApi);
    let cancelled = false;
    let request: Request;
    const watch = async () => {
      if (cancelled) {
      ...
      try {
        ...
        channel(V1AlertmanagerActions.fetch.failure({ error }));
