...
export class V1Alpha2ChallengeApi {
  ...
  public setApiKey(key: V1Alpha2ChallengeApiApiKeys, value: string) {
    (this.authentications as any)[
      V1Alpha2ChallengeApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async createNamespacedV1Alpha2Challenge(
    namespace: string,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Alpha2Challenge }> {
    const localVarPath =
      this.basePath +
      "/apis/acme.cert-manager.io/v1alpha2/namespaces/{namespace}/challenges".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Alpha2Challenge."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Alpha2Challenge."
      );
    }
   ...
   */
  public async readNamespacedV1Alpha2Challenge(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    const localVarPath =
      this.basePath +
      "/apis/acme.cert-manager.io/v1alpha2/namespaces/{namespace}/challenges/{name}"
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Alpha2Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Alpha2Challenge."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Alpha2Challenge(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Alpha2Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Alpha2Challenge."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Alpha2Challenge."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Alpha2Challenge(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Alpha2Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Alpha2Challenge."
      );
    }
  ...
  public async listV1Alpha2ChallengeForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Alpha2ChallengeList }> {
    const localVarPath =
      this.basePath + "/apis/acme.cert-manager.io/v1alpha2/challenges";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Alpha2ChallengeResource = <
  (r: K8sResource) => r is V1Alpha2ChallengeResourceType
...
export const V1Alpha2ChallengeActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1ALPHA2CHALLENGE"
  )<V1Alpha2ChallengeResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1ALPHA2CHALLENGE"
  )<V1Alpha2ChallengeResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1ALPHA2CHALLENGE"
  )<V1Alpha2ChallengeResourceType>()
};
export type V1Alpha2ChallengeResourceActions = ActionType<
  typeof V1Alpha2ChallengeActions
>;
export interface V1Alpha2ChallengeResourceState
  extends ResourceCache<V1Alpha2ChallengeResourceType> {}
...
export class V1Alpha2ChallengeResource extends K8sResource {
    ...
    const watch = async () => {
        ...
        channel(
          V1Alpha2ChallengeActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Alpha2ChallengeResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Alpha2Challenge) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Alpha2ChallengeActions.onAdded(
                new V1Alpha2ChallengeResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
            channel(
              V1Alpha2ChallengeActions.onUpdated(
                new V1Alpha2ChallengeResource(obj, kubeConfig)
              )
            );
            break;
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Alpha2Challenge(
      this.namespace,
      this.resource
    );
  }
  ...
  delete(): Promise<{
    ...
    return this.api.deleteNamespacedV1Alpha2Challenge(
      this.name,
      this.namespace
    );
  }
