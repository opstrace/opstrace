...
export class V1Beta1ChallengeApi {
  ...
  public setApiKey(key: V1Beta1ChallengeApiApiKeys, value: string) {
    (this.authentications as any)[V1Beta1ChallengeApiApiKeys[key]].apiKey = value;
  }
   ...
   */
  public async createNamespacedV1Beta1Challenge (namespace: string, body: V1Beta1Challenge, includeUninitialized?: boolean, pretty?: string, dryRun?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Beta1Challenge;  }> {
    const localVarPath = this.basePath + '/apis/acme.cert-manager.io/v1beta1/namespaces/{namespace}/challenges'
    ...
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling createNamespacedV1Beta1Challenge.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
        throw new Error('Required parameter body was null or undefined when calling createNamespacedV1Beta1Challenge.');
    }
    ...
    return authenticationPromise.then(() => {
        ...
        return new Promise<{ response: IncomingMessage; body: V1Beta1Challenge;  }>((resolve, reject) => {
   ...
   */
  public async readNamespacedV1Beta1Challenge (name: string, namespace: string, pretty?: string, exact?: boolean, _export?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Beta1Challenge;  }> {
    const localVarPath = this.basePath + '/apis/acme.cert-manager.io/v1beta1/namespaces/{namespace}/challenges/{name}'
    ...
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling readNamespacedV1Beta1Challenge.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling readNamespacedV1Beta1Challenge.');
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Beta1Challenge (name: string, namespace: string, body: object, pretty?: string, dryRun?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Beta1Challenge;  }> {
    const localVarPath = this.basePath + '/apis/acme.cert-manager.io/v1beta1/namespaces/{namespace}/challenges/{name}'
        .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
        .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    let localVarQueryParameters: any = {};
    ...
    // verify required parameter 'name' is not null or undefined
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling patchNamespacedV1Beta1Challenge.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling patchNamespacedV1Beta1Challenge.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
        throw new Error('Required parameter body was null or undefined when calling patchNamespacedV1Beta1Challenge.');
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Beta1Challenge (name: string, namespace: string, pretty?: string, dryRun?: string, gracePeriodSeconds?: number, orphanDependents?: boolean, propagationPolicy?: string, body?: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Status;  }> {
    const localVarPath = this.basePath + '/apis/acme.cert-manager.io/v1beta1/namespaces/{namespace}/challenges/{name}'
        .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
        .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    let localVarQueryParameters: any = {};
    ...
    // verify required parameter 'name' is not null or undefined
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling deleteNamespacedV1Beta1Challenge.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling deleteNamespacedV1Beta1Challenge.');
    }
   ...
   */
  public async listV1Beta1ChallengeForAllNamespaces (allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, timeoutSeconds?: number, watch?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Beta1ChallengeList;  }> {
      const localVarPath = this.basePath + '/apis/acme.cert-manager.io/v1beta1/challenges';
      let localVarQueryParameters: any = {};
      let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
      let localVarFormParams: any = {};
      ...
      return authenticationPromise.then(() => {
          ...
          return new Promise<{ response: IncomingMessage; body: V1Beta1ChallengeList;  }>((resolve, reject) => {
              localVarRequest(localVarRequestOptions, (error, response, body) => {
                  if (error) {
                      reject(error);
                  } else {
...
export const isV1Beta1ChallengeResource = <(r: K8sResource) => r is V1Beta1ChallengeResourceType>(
...
export const V1Beta1ChallengeActions = {
  ...
  onUpdated: createAction("ON_UPDATED_K8S_V1BETA1CHALLENGE")<V1Beta1ChallengeResourceType>(),
  onAdded: createAction("ON_ADDED_K8S_V1BETA1CHALLENGE")<V1Beta1ChallengeResourceType>(),
  onDestroyed: createAction("ON_DESTROYED_K8S_V1BETA1CHALLENGE")<V1Beta1ChallengeResourceType>()
};
export type V1Beta1ChallengeResourceActions = ActionType<typeof V1Beta1ChallengeActions>;
export interface V1Beta1ChallengeResourceState extends ResourceCache<V1Beta1ChallengeResourceType> {}
...
export class V1Beta1ChallengeResource extends K8sResource {
  ...
  static startInformer(
    ...
    const watch = async () => {
      ...
      try {
        ...
        channel(
          V1Beta1ChallengeActions.fetch.success({
            resources: res.body.items.map(r => new V1Beta1ChallengeResource(r, kubeConfig))
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Beta1Challenge) => {
        switch (phase) {
          case "ADDED":
            channel(V1Beta1ChallengeActions.onAdded(new V1Beta1ChallengeResource(obj, kubeConfig)));
            break;
          case "MODIFIED":
            channel(V1Beta1ChallengeActions.onUpdated(new V1Beta1ChallengeResource(obj, kubeConfig)));
            break;
          case "DELETED":
            channel(
              V1Beta1ChallengeActions.onDestroyed(new V1Beta1ChallengeResource(obj, kubeConfig))
            );
            break;
        }
      };
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Beta1Challenge(this.namespace, this.resource)
