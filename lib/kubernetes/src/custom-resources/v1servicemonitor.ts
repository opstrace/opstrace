 ...
 */
export interface V1Servicemonitor {
  /**
...
export class V1ServicemonitorApi {
  ...
  /**
   * read the specified V1Servicemonitor
  ...
  /**
   * list or watch objects of kind V1Servicemonitor
...
export const V1ServicemonitorActions = {
  fetch: createAsyncAction(
    "FETCH_K8S_V1SERVICEMONITORS_REQUEST",
...
export const V1ServicemonitorReducer = createReducer<
  V1ServicemonitorResourceState,
  V1ServicemonitorResourceActions
>(initialState)
  .handleAction(
    V1ServicemonitorActions.fetch.request,
    (state, _): V1ServicemonitorResourceState => ({
      ...state,
      loaded: false
    })
  )
  ...
  .handleAction(
    V1ServicemonitorActions.fetch.failure,
    (state, action): V1ServicemonitorResourceState => ({
      ...state,
      ...action.payload,
      loaded: false
  ...
  .handleAction(
    [V1ServicemonitorActions.onUpdated, V1ServicemonitorActions.onAdded],
    (state, action): V1ServicemonitorResourceState => ({
      ...state,
      resources: [
...
export class V1ServicemonitorResource extends K8sResource {
  protected api: V1ServicemonitorApi;
  protected resource: V1Servicemonitor;

  constructor(resource: V1Servicemonitor, kubeConfig: KubeConfig) {
    super(resource, kubeConfig);

    this.resource = resource;
    this.api = kubeConfig.makeApiClient(V1ServicemonitorApi);
  }
  get spec(): V1Servicemonitor {
  ...
  static startInformer(
    ...
    const client = kubeConfig.makeApiClient(V1ServicemonitorApi);
    let cancelled = false;
    let request: Request;
    const watch = async () => {
      if (cancelled) {
      ...
      try {
        ...
        channel(V1ServicemonitorActions.fetch.failure({ error }));
