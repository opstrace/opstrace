 ...
 */
export interface V1Clickhouseinstallation {
  /**
...
export interface V1ClickhouseinstallationList {
  /**
   ...
   */
   items: Array<V1Clickhouseinstallation>;
   /**
...
export enum V1ClickhouseinstallationApiApiKeys {
    BearerToken,
}

export class V1ClickhouseinstallationApi {
  ...
  public setApiKey(key: V1ClickhouseinstallationApiApiKeys, value: string) {
    (this.authentications as any)[V1ClickhouseinstallationApiApiKeys[key]].apiKey = value;
  }
  ...
  /**
   * create a V1Clickhouseinstallation
   ...
   */
  public async createNamespacedV1Clickhouseinstallation (namespace: string, body: V1Clickhouseinstallation, includeUninitialized?: boolean, pretty?: string, dryRun?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Clickhouseinstallation;  }> {
    const localVarPath = this.basePath + '/apis/clickhouse.altinity.com/v1/namespaces/{namespace}/clickhouseinstallations'
    ...
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling createNamespacedV1Clickhouseinstallation.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
        throw new Error('Required parameter body was null or undefined when calling createNamespacedV1Clickhouseinstallation.');
    }
    ...
    return authenticationPromise.then(() => {
        ...
        return new Promise<{ response: IncomingMessage; body: V1Clickhouseinstallation;  }>((resolve, reject) => {
  ...
  /**
   * read the specified V1Clickhouseinstallation
   * @param name name of the V1Clickhouseinstallation
   * @param namespace object name and auth scope, such as for teams and projects
   * @param pretty If &#39;true&#39;, then the output is pretty printed.
   ...
   */
  public async readNamespacedV1Clickhouseinstallation (name: string, namespace: string, pretty?: string, exact?: boolean, _export?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Clickhouseinstallation;  }> {
    const localVarPath = this.basePath + '/apis/clickhouse.altinity.com/v1/namespaces/{namespace}/clickhouseinstallations/{name}'
    ...
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling readNamespacedV1Clickhouseinstallation.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling readNamespacedV1Clickhouseinstallation.');
    }
  ...
  /**
   * partially update the specified V1Clickhouseinstallation
   * @param name name of the V1Clickhouseinstallation
   * @param namespace object name and auth scope, such as for teams and projects
   * @param body
   * @param pretty If &#39;true&#39;, then the output is pretty printed.
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Clickhouseinstallation (name: string, namespace: string, body: object, pretty?: string, dryRun?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Clickhouseinstallation;  }> {
    const localVarPath = this.basePath + '/apis/clickhouse.altinity.com/v1/namespaces/{namespace}/clickhouseinstallations/{name}'
        .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
        .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    let localVarQueryParameters: any = {};
    ...
    // verify required parameter 'name' is not null or undefined
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling patchNamespacedV1Clickhouseinstallation.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling patchNamespacedV1Clickhouseinstallation.');
    }

    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
        throw new Error('Required parameter body was null or undefined when calling patchNamespacedV1Clickhouseinstallation.');
    }
  ...
  /**
   * delete a V1Clickhouseinstallation
   * @param name name of the V1Clickhouseinstallation
   * @param namespace object name and auth scope, such as for teams and projects
   * @param pretty If &#39;true&#39;, then the output is pretty printed.
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   ...
   * @param body
   */
  public async deleteNamespacedV1Clickhouseinstallation (name: string, namespace: string, pretty?: string, dryRun?: string, gracePeriodSeconds?: number, orphanDependents?: boolean, propagationPolicy?: string, body?: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1Status;  }> {
    const localVarPath = this.basePath + '/apis/clickhouse.altinity.com/v1/namespaces/{namespace}/clickhouseinstallations/{name}'
        .replace('{' + 'name' + '}', encodeURIComponent(String(name)))
        .replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    let localVarQueryParameters: any = {};
    ...
    // verify required parameter 'name' is not null or undefined
    if (name === null || name === undefined) {
        throw new Error('Required parameter name was null or undefined when calling deleteNamespacedV1Clickhouseinstallation.');
    }

    // verify required parameter 'namespace' is not null or undefined
    if (namespace === null || namespace === undefined) {
        throw new Error('Required parameter namespace was null or undefined when calling deleteNamespacedV1Clickhouseinstallation.');
    }
  ...
  /**
   * list or watch objects of kind V1Clickhouseinstallation
   ...
   */
  public async listV1ClickhouseinstallationForAllNamespaces (allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, timeoutSeconds?: number, watch?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: IncomingMessage; body: V1ClickhouseinstallationList;  }> {
      const localVarPath = this.basePath + '/apis/clickhouse.altinity.com/v1/clickhouseinstallations';
      let localVarQueryParameters: any = {};
      let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
      let localVarFormParams: any = {};
      ...
      return authenticationPromise.then(() => {
          ...
          return new Promise<{ response: IncomingMessage; body: V1ClickhouseinstallationList;  }>((resolve, reject) => {
              localVarRequest(localVarRequestOptions, (error, response, body) => {
                  if (error) {
                      reject(error);
                  } else {
...
export type V1ClickhouseinstallationResourceType = V1ClickhouseinstallationResource;
export type V1ClickhouseinstallationResources = V1ClickhouseinstallationResourceType[];

export const isV1ClickhouseinstallationResource = <(r: K8sResource) => r is V1ClickhouseinstallationResourceType>(
  (resource => resource instanceof V1ClickhouseinstallationResource)
);

export const V1ClickhouseinstallationActions = {
  fetch: createAsyncAction(
    "FETCH_K8S_V1CLICKHOUSEINSTALLATIONS_REQUEST",
    "FETCH_K8S_V1CLICKHOUSEINSTALLATIONS_SUCCESS",
    "FETCH_K8S_V1CLICKHOUSEINSTALLATIONS_FAILURE"
  )<{}, { resources: V1ClickhouseinstallationResources }, { error: Error }>(),
  onUpdated: createAction("ON_UPDATED_K8S_V1CLICKHOUSEINSTALLATION")<V1ClickhouseinstallationResourceType>(),
  onAdded: createAction("ON_ADDED_K8S_V1CLICKHOUSEINSTALLATION")<V1ClickhouseinstallationResourceType>(),
  onDestroyed: createAction("ON_DESTROYED_K8S_V1CLICKHOUSEINSTALLATION")<V1ClickhouseinstallationResourceType>()
};
export type V1ClickhouseinstallationResourceActions = ActionType<typeof V1ClickhouseinstallationActions>;
export interface V1ClickhouseinstallationResourceState extends ResourceCache<V1ClickhouseinstallationResourceType> {}

const initialState: V1ClickhouseinstallationResourceState = {
  loaded: false,
  error: null,
  resources: []
};

export const V1ClickhouseinstallationReducer = createReducer<
  V1ClickhouseinstallationResourceState,
  V1ClickhouseinstallationResourceActions
>(initialState)
  .handleAction(
    V1ClickhouseinstallationActions.fetch.request,
    (state, _): V1ClickhouseinstallationResourceState => ({
      ...state,
      loaded: false
    })
  )
  .handleAction(
    V1ClickhouseinstallationActions.fetch.success,
    (state, action): V1ClickhouseinstallationResourceState => ({
      ...state,
      ...action.payload,
      error: null,
      loaded: true
  ...
  .handleAction(
    V1ClickhouseinstallationActions.fetch.failure,
    (state, action): V1ClickhouseinstallationResourceState => ({
      ...state,
      ...action.payload,
      loaded: false
  ...
  .handleAction(
    [V1ClickhouseinstallationActions.onUpdated, V1ClickhouseinstallationActions.onAdded],
    (state, action): V1ClickhouseinstallationResourceState => ({
      ...state,
      resources: [
  ...
  .handleAction(
    V1ClickhouseinstallationActions.onDestroyed,
    (state, action): V1ClickhouseinstallationResourceState => ({
      ...state,
...
export class V1ClickhouseinstallationResource extends K8sResource {
  protected api: V1ClickhouseinstallationApi;
  protected resource: V1Clickhouseinstallation;

  constructor(resource: V1Clickhouseinstallation, kubeConfig: KubeConfig) {
    super(resource, kubeConfig);

    this.resource = resource;
    this.api = kubeConfig.makeApiClient(V1ClickhouseinstallationApi);
  }
  get spec(): V1Clickhouseinstallation {
  ...
  static startInformer(
    ...
    const client = kubeConfig.makeApiClient(V1ClickhouseinstallationApi);
    let cancelled = false;
    let request: Request;
    ...
    const watch = async () => {
      ...
      try {
        const res = await client.listV1ClickhouseinstallationForAllNamespaces();
        channel(
          V1ClickhouseinstallationActions.fetch.success({
            resources: res.body.items.map(r => new V1ClickhouseinstallationResource(r, kubeConfig))
          })
        );
      } catch (error: any) {
        channel(V1ClickhouseinstallationActions.fetch.failure({ error }));
        log.warning("starting informer failed (will retry):  %s", error);
        return setTimeout(watch, 3000);
      }
      const informer = new Watch(kubeConfig);
      const watchHandler = (phase: string, obj: V1Clickhouseinstallation) => {
        switch (phase) {
          case "ADDED":
            channel(V1ClickhouseinstallationActions.onAdded(new V1ClickhouseinstallationResource(obj, kubeConfig)));
            break;
          case "MODIFIED":
            channel(V1ClickhouseinstallationActions.onUpdated(new V1ClickhouseinstallationResource(obj, kubeConfig)));
            break;
          case "DELETED":
            channel(
              V1ClickhouseinstallationActions.onDestroyed(new V1ClickhouseinstallationResource(obj, kubeConfig))
            );
            break;
        }
      };
      request = await informer.watch(
        "/apis/clickhouse.altinity.com/v1/clickhouseinstallations",
  ...
  create(): Promise<{
    ...
    body: V1Clickhouseinstallation;
  }> {
    return this.api.createNamespacedV1Clickhouseinstallation(this.namespace, this.resource)
  ...
  read(): Promise<{
    ...
    return this.api.readNamespacedV1Clickhouseinstallation(this.name, this.namespace)
  ...
  update(): Promise<{
    ...
    return this.api.patchNamespacedV1Clickhouseinstallation(
        this.name,
        this.namespace,
        this.resource,
        undefined,
  ...
  delete(): Promise<{
    ...
    return this.api.deleteNamespacedV1Clickhouseinstallation(this.name, this.namespace)
  }
}
