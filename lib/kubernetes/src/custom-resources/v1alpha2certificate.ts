...
export class V1Alpha2CertificateApi {
  ...
  /**
   * read the specified V1Alpha2Certificate
  ...
  /**
   * list or watch objects of kind V1Alpha2Certificate
...
export const V1Alpha2CertificateActions = {
  fetch: createAsyncAction(
    "FETCH_K8S_V1ALPHA2CERTIFICATES_REQUEST",
...
export const V1Alpha2CertificateReducer = createReducer<
  V1Alpha2CertificateResourceState,
  V1Alpha2CertificateResourceActions
>(initialState)
  .handleAction(
    V1Alpha2CertificateActions.fetch.request,
    (state, _): V1Alpha2CertificateResourceState => ({
      ...state,
      loaded: false
    })
  )
  ...
  .handleAction(
    V1Alpha2CertificateActions.fetch.failure,
    (state, action): V1Alpha2CertificateResourceState => ({
      ...state,
      ...action.payload,
      loaded: false
  ...
  .handleAction(
    [V1Alpha2CertificateActions.onUpdated, V1Alpha2CertificateActions.onAdded],
    (state, action): V1Alpha2CertificateResourceState => ({
      ...state,
      resources: [
...
export class V1Alpha2CertificateResource extends K8sResource {
  protected api: V1Alpha2CertificateApi;
  protected resource: V1Alpha2Certificate;

  constructor(resource: V1Alpha2Certificate, kubeConfig: KubeConfig) {
    super(resource, kubeConfig);

    this.resource = resource;
    this.api = kubeConfig.makeApiClient(V1Alpha2CertificateApi);
  }
  get spec(): V1Alpha2Certificate {
  ...
  static startInformer(
    ...
    const watch = async () => {
      ...
      try {
        ...
        channel(V1Alpha2CertificateActions.fetch.failure({ error }));
