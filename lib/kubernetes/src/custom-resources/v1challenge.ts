...
export class V1ChallengeApi {
   ...
   */
  public async createNamespacedV1Challenge(
    namespace: string,
    body: V1Challenge,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Challenge }> {
    const localVarPath =
      this.basePath +
      "/apis/acme.cert-manager.io/v1/namespaces/{namespace}/challenges".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Challenge."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Challenge."
      );
    }
    ...
    return authenticationPromise.then(() => {
      ...
      return new Promise<{ response: IncomingMessage; body: V1Challenge }>(
        (resolve, reject) => {
   ...
   */
  public async readNamespacedV1Challenge(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    const localVarPath =
      this.basePath +
      "/apis/acme.cert-manager.io/v1/namespaces/{namespace}/challenges/{name}"
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Challenge."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Challenge(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Challenge."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Challenge."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Challenge(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Challenge."
      );
    }
   ...
   */
  public async listV1ChallengeForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1ChallengeList }> {
    const localVarPath =
      this.basePath + "/apis/acme.cert-manager.io/v1/challenges";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
    ...
    return authenticationPromise.then(() => {
      ...
      return new Promise<{ response: IncomingMessage; body: V1ChallengeList }>(
        (resolve, reject) => {
          localVarRequest(localVarRequestOptions, (error, response, body) => {
            if (error) {
              reject(error);
...
export const isV1ChallengeResource = <
  (r: K8sResource) => r is V1ChallengeResourceType
    ...
    const watch = async () => {
        ...
        channel(
          V1ChallengeActions.fetch.success({
            resources: res.body.items.map(
              r => new V1ChallengeResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Challenge) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1ChallengeActions.onAdded(
                new V1ChallengeResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
            channel(
              V1ChallengeActions.onUpdated(
                new V1ChallengeResource(obj, kubeConfig)
              )
            );
            break;
