...
export class V1Alpha2OrderApi {
   ...
   */
  public async createNamespacedV1Alpha2Order(
    namespace: string,
    body: V1Alpha2Order,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Alpha2Order }> {
    const localVarPath =
      this.basePath +
      "/apis/acme.cert-manager.io/v1alpha2/namespaces/{namespace}/orders".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Alpha2Order."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Alpha2Order."
      );
    }
    ...
    return authenticationPromise.then(() => {
      ...
      return new Promise<{ response: IncomingMessage; body: V1Alpha2Order }>(
        (resolve, reject) => {
   ...
   */
  public async readNamespacedV1Alpha2Order(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Alpha2Order."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Alpha2Order."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Alpha2Order(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Alpha2Order."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Alpha2Order."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Alpha2Order."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Alpha2Order(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Alpha2Order."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Alpha2Order."
      );
    }
   ...
   */
  public async listV1Alpha2OrderForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Alpha2OrderList }> {
    const localVarPath =
      this.basePath + "/apis/acme.cert-manager.io/v1alpha2/orders";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Alpha2OrderResource = <
  (r: K8sResource) => r is V1Alpha2OrderResourceType
...
export const V1Alpha2OrderActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1ALPHA2ORDER"
  )<V1Alpha2OrderResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1ALPHA2ORDER"
  )<V1Alpha2OrderResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1ALPHA2ORDER"
  )<V1Alpha2OrderResourceType>()
};
export type V1Alpha2OrderResourceActions = ActionType<
  typeof V1Alpha2OrderActions
>;
export interface V1Alpha2OrderResourceState
  extends ResourceCache<V1Alpha2OrderResourceType> {}
...
export class V1Alpha2OrderResource extends K8sResource {
    ...
    const watch = async () => {
        ...
        channel(
          V1Alpha2OrderActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Alpha2OrderResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Alpha2Order) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Alpha2OrderActions.onAdded(
                new V1Alpha2OrderResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
            channel(
              V1Alpha2OrderActions.onUpdated(
                new V1Alpha2OrderResource(obj, kubeConfig)
              )
            );
            break;
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Alpha2Order(
      this.namespace,
      this.resource
    );
  }
