...
export class V1Alpha3CertificateApi {
  ...
  public setApiKey(key: V1Alpha3CertificateApiApiKeys, value: string) {
    (this.authentications as any)[
      V1Alpha3CertificateApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async createNamespacedV1Alpha3Certificate(
    namespace: string,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Alpha3Certificate }> {
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1alpha3/namespaces/{namespace}/certificates".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Alpha3Certificate."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Alpha3Certificate."
      );
    }
   ...
   */
  public async readNamespacedV1Alpha3Certificate(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Alpha3Certificate."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Alpha3Certificate."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Alpha3Certificate(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Alpha3Certificate."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Alpha3Certificate."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Alpha3Certificate."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Alpha3Certificate(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Alpha3Certificate."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Alpha3Certificate."
      );
    }
  ...
  public async listV1Alpha3CertificateForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Alpha3CertificateList }> {
    const localVarPath =
      this.basePath + "/apis/cert-manager.io/v1alpha3/certificates";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Alpha3CertificateResource = <
  (r: K8sResource) => r is V1Alpha3CertificateResourceType
...
export const V1Alpha3CertificateActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1ALPHA3CERTIFICATE"
  )<V1Alpha3CertificateResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1ALPHA3CERTIFICATE"
  )<V1Alpha3CertificateResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1ALPHA3CERTIFICATE"
  )<V1Alpha3CertificateResourceType>()
};
export type V1Alpha3CertificateResourceActions = ActionType<
  typeof V1Alpha3CertificateActions
>;
export interface V1Alpha3CertificateResourceState
  extends ResourceCache<V1Alpha3CertificateResourceType> {}
...
export class V1Alpha3CertificateResource extends K8sResource {
    ...
    const watch = async () => {
        ...
        channel(
          V1Alpha3CertificateActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Alpha3CertificateResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Alpha3Certificate) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Alpha3CertificateActions.onAdded(
                new V1Alpha3CertificateResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
            channel(
              V1Alpha3CertificateActions.onUpdated(
                new V1Alpha3CertificateResource(obj, kubeConfig)
              )
            );
            break;
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Alpha3Certificate(
      this.namespace,
      this.resource
    );
  }
  read(): Promise<{
    ...
    return this.api.readNamespacedV1Alpha3Certificate(
      this.name,
      this.namespace
    );
  }
  ...
  delete(): Promise<{
    ...
    return this.api.deleteNamespacedV1Alpha3Certificate(
      this.name,
      this.namespace
    );
  }
