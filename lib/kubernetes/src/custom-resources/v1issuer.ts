...
export class V1IssuerApi {
   ...
   */
  public async createNamespacedV1Issuer(
    namespace: string,
    body: V1Issuer,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Issuer }> {
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1/namespaces/{namespace}/issuers".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Issuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Issuer."
      );
    }
    ...
    return authenticationPromise.then(() => {
      ...
      return new Promise<{ response: IncomingMessage; body: V1Issuer }>(
        (resolve, reject) => {
   ...
   */
  public async readNamespacedV1Issuer(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Issuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Issuer."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Issuer(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Issuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Issuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Issuer."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Issuer(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Issuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Issuer."
      );
    }
  ...
  public async listV1IssuerForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1IssuerList }> {
    ...
    return authenticationPromise.then(() => {
      ...
      return new Promise<{ response: IncomingMessage; body: V1IssuerList }>(
        (resolve, reject) => {
          localVarRequest(localVarRequestOptions, (error, response, body) => {
            if (error) {
              reject(error);
...
export const isV1IssuerResource = <
  (r: K8sResource) => r is V1IssuerResourceType
...
export interface V1IssuerResourceState
  extends ResourceCache<V1IssuerResourceType> {}
    ...
    const watch = async () => {
        ...
        channel(
          V1IssuerActions.fetch.success({
            resources: res.body.items.map(
              r => new V1IssuerResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Issuer) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1IssuerActions.onAdded(new V1IssuerResource(obj, kubeConfig))
            );
            break;
          case "MODIFIED":
            channel(
              V1IssuerActions.onUpdated(new V1IssuerResource(obj, kubeConfig))
            );
            break;
          case "DELETED":
            channel(
