...
export class V1Beta1ClusterissuerApi {
  ...
  public setApiKey(key: V1Beta1ClusterissuerApiApiKeys, value: string) {
    (this.authentications as any)[
      V1Beta1ClusterissuerApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async createNamespacedV1Beta1Clusterissuer(
    namespace: string,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Beta1Clusterissuer }> {
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1beta1/clusterissuers".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Beta1Clusterissuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Beta1Clusterissuer."
      );
    }
   ...
   */
  public async readNamespacedV1Beta1Clusterissuer(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1beta1/clusterissuers/{name}"
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Beta1Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Beta1Clusterissuer."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Beta1Clusterissuer(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Beta1Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Beta1Clusterissuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Beta1Clusterissuer."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Beta1Clusterissuer(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Beta1Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Beta1Clusterissuer."
      );
    }
  ...
  public async listV1Beta1ClusterissuerForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Beta1ClusterissuerList }> {
    const localVarPath =
      this.basePath + "/apis/cert-manager.io/v1beta1/clusterissuers";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Beta1ClusterissuerResource = <
  (r: K8sResource) => r is V1Beta1ClusterissuerResourceType
...
export const V1Beta1ClusterissuerActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1BETA1CLUSTERISSUER"
  )<V1Beta1ClusterissuerResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1BETA1CLUSTERISSUER"
  )<V1Beta1ClusterissuerResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1BETA1CLUSTERISSUER"
  )<V1Beta1ClusterissuerResourceType>()
};
export type V1Beta1ClusterissuerResourceActions = ActionType<
  typeof V1Beta1ClusterissuerActions
>;
export interface V1Beta1ClusterissuerResourceState
  extends ResourceCache<V1Beta1ClusterissuerResourceType> {}
...
>(initialState)
  ...
  .handleAction(
    [
      V1Beta1ClusterissuerActions.onUpdated,
      V1Beta1ClusterissuerActions.onAdded
    ],
    (state, action): V1Beta1ClusterissuerResourceState => ({
      ...state,
      resources: [
...
export class V1Beta1ClusterissuerResource extends K8sResource {
        ...
        channel(
          V1Beta1ClusterissuerActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Beta1ClusterissuerResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Beta1Clusterissuer) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Beta1ClusterissuerActions.onAdded(
                new V1Beta1ClusterissuerResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Beta1Clusterissuer(
      this.namespace,
      this.resource
    );
  }
  read(): Promise<{
    ...
    return this.api.readNamespacedV1Beta1Clusterissuer(
      this.name,
      this.namespace
    );
  }
  ...
  delete(): Promise<{
    ...
    return this.api.deleteNamespacedV1Beta1Clusterissuer(
      this.name,
      this.namespace
    );
  }
