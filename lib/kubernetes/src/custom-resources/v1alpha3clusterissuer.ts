...
export class V1Alpha3ClusterissuerApi {
  ...
  public setApiKey(key: V1Alpha3ClusterissuerApiApiKeys, value: string) {
    (this.authentications as any)[
      V1Alpha3ClusterissuerApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async createNamespacedV1Alpha3Clusterissuer(
    namespace: string,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Alpha3Clusterissuer }> {
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1alpha3/clusterissuers".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Alpha3Clusterissuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Alpha3Clusterissuer."
      );
    }
   ...
   */
  public async readNamespacedV1Alpha3Clusterissuer(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1alpha3/clusterissuers/{name}"
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Alpha3Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Alpha3Clusterissuer."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Alpha3Clusterissuer(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Alpha3Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Alpha3Clusterissuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Alpha3Clusterissuer."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Alpha3Clusterissuer(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Alpha3Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Alpha3Clusterissuer."
      );
    }
   ...
   */
  public async listV1Alpha3ClusterissuerForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Alpha3ClusterissuerList }> {
    const localVarPath =
      this.basePath + "/apis/cert-manager.io/v1alpha3/clusterissuers";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Alpha3ClusterissuerResource = <
  (r: K8sResource) => r is V1Alpha3ClusterissuerResourceType
...
export const V1Alpha3ClusterissuerActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1ALPHA3CLUSTERISSUER"
  )<V1Alpha3ClusterissuerResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1ALPHA3CLUSTERISSUER"
  )<V1Alpha3ClusterissuerResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1ALPHA3CLUSTERISSUER"
  )<V1Alpha3ClusterissuerResourceType>()
};
export type V1Alpha3ClusterissuerResourceActions = ActionType<
  typeof V1Alpha3ClusterissuerActions
>;
export interface V1Alpha3ClusterissuerResourceState
  extends ResourceCache<V1Alpha3ClusterissuerResourceType> {}
...
>(initialState)
  ...
  .handleAction(
    [
      V1Alpha3ClusterissuerActions.onUpdated,
      V1Alpha3ClusterissuerActions.onAdded
    ],
    (state, action): V1Alpha3ClusterissuerResourceState => ({
      ...state,
      resources: [
...
export class V1Alpha3ClusterissuerResource extends K8sResource {
        ...
        channel(
          V1Alpha3ClusterissuerActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Alpha3ClusterissuerResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Alpha3Clusterissuer) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Alpha3ClusterissuerActions.onAdded(
                new V1Alpha3ClusterissuerResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Alpha3Clusterissuer(
      this.namespace,
      this.resource
    );
  }
  read(): Promise<{
    ...
    return this.api.readNamespacedV1Alpha3Clusterissuer(
      this.name,
      this.namespace
    );
  }
  ...
  delete(): Promise<{
    ...
    return this.api.deleteNamespacedV1Alpha3Clusterissuer(
      this.name,
      this.namespace
    );
  }
