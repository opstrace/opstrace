...
export class V1Beta1IssuerApi {
   ...
   */
  public async createNamespacedV1Beta1Issuer(
    namespace: string,
    body: V1Beta1Issuer,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Beta1Issuer }> {
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1beta1/namespaces/{namespace}/issuers".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Beta1Issuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Beta1Issuer."
      );
    }
    ...
    return authenticationPromise.then(() => {
      ...
      return new Promise<{ response: IncomingMessage; body: V1Beta1Issuer }>(
        (resolve, reject) => {
   ...
   */
  public async readNamespacedV1Beta1Issuer(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Beta1Issuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Beta1Issuer."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Beta1Issuer(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Beta1Issuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Beta1Issuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Beta1Issuer."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Beta1Issuer(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Beta1Issuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Beta1Issuer."
      );
    }
  ...
  public async listV1Beta1IssuerForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Beta1IssuerList }> {
    const localVarPath =
      this.basePath + "/apis/cert-manager.io/v1beta1/issuers";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Beta1IssuerResource = <
  (r: K8sResource) => r is V1Beta1IssuerResourceType
...
export const V1Beta1IssuerActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1BETA1ISSUER"
  )<V1Beta1IssuerResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1BETA1ISSUER"
  )<V1Beta1IssuerResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1BETA1ISSUER"
  )<V1Beta1IssuerResourceType>()
};
export type V1Beta1IssuerResourceActions = ActionType<
  typeof V1Beta1IssuerActions
>;
export interface V1Beta1IssuerResourceState
  extends ResourceCache<V1Beta1IssuerResourceType> {}
...
export class V1Beta1IssuerResource extends K8sResource {
    ...
    const watch = async () => {
        ...
        channel(
          V1Beta1IssuerActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Beta1IssuerResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Beta1Issuer) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Beta1IssuerActions.onAdded(
                new V1Beta1IssuerResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
            channel(
              V1Beta1IssuerActions.onUpdated(
                new V1Beta1IssuerResource(obj, kubeConfig)
              )
            );
            break;
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Beta1Issuer(
      this.namespace,
      this.resource
    );
  }
