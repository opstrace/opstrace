...
export class V1ClusterissuerApi {
   ...
   */
  public async createNamespacedV1Clusterissuer(
    namespace: string,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Clusterissuer }> {
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1/clusterissuers".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Clusterissuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Clusterissuer."
      );
    }
    ...
    return authenticationPromise.then(() => {
      ...
      return new Promise<{ response: IncomingMessage; body: V1Clusterissuer }>(
        (resolve, reject) => {
   ...
   */
  public async readNamespacedV1Clusterissuer(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    const localVarPath =
      this.basePath +
      "/apis/cert-manager.io/v1/clusterissuers/{name}"
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Clusterissuer."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Clusterissuer(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Clusterissuer."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Clusterissuer."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Clusterissuer(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Clusterissuer."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Clusterissuer."
      );
    }
  ...
  public async listV1ClusterissuerForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1ClusterissuerList }> {
    const localVarPath =
      this.basePath + "/apis/cert-manager.io/v1/clusterissuers";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1ClusterissuerResource = <
  (r: K8sResource) => r is V1ClusterissuerResourceType
...
export const V1ClusterissuerActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1CLUSTERISSUER"
  )<V1ClusterissuerResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1CLUSTERISSUER"
  )<V1ClusterissuerResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1CLUSTERISSUER"
  )<V1ClusterissuerResourceType>()
};
export type V1ClusterissuerResourceActions = ActionType<
  typeof V1ClusterissuerActions
>;
export interface V1ClusterissuerResourceState
  extends ResourceCache<V1ClusterissuerResourceType> {}
...
export class V1ClusterissuerResource extends K8sResource {
    ...
    const watch = async () => {
        ...
        channel(
          V1ClusterissuerActions.fetch.success({
            resources: res.body.items.map(
              r => new V1ClusterissuerResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Clusterissuer) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1ClusterissuerActions.onAdded(
                new V1ClusterissuerResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
            channel(
              V1ClusterissuerActions.onUpdated(
                new V1ClusterissuerResource(obj, kubeConfig)
              )
            );
            break;
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Clusterissuer(
      this.namespace,
      this.resource
    );
  }
