...
export class V1PrometheusApi {
  ...
  public setApiKey(key: V1PrometheusApiApiKeys, value: string) {
    (this.authentications as any)[V1PrometheusApiApiKeys[key]].apiKey = value;
  }
  ...
  /**
   * read the specified V1Prometheus
  ...
  /**
   * list or watch objects of kind V1Prometheus
...
export const V1PrometheusActions = {
  fetch: createAsyncAction(
    "FETCH_K8S_V1PROMETHEUSS_REQUEST",
...
export const V1PrometheusReducer = createReducer<
  V1PrometheusResourceState,
  V1PrometheusResourceActions
>(initialState)
  .handleAction(
    V1PrometheusActions.fetch.request,
    (state, _): V1PrometheusResourceState => ({
      ...state,
      loaded: false
    })
  )
  ...
  .handleAction(
    V1PrometheusActions.fetch.failure,
    (state, action): V1PrometheusResourceState => ({
      ...state,
      ...action.payload,
      loaded: false
  ...
  .handleAction(
    [V1PrometheusActions.onUpdated, V1PrometheusActions.onAdded],
    (state, action): V1PrometheusResourceState => ({
      ...state,
      resources: [
...
export class V1PrometheusResource extends K8sResource {
  protected api: V1PrometheusApi;
  protected resource: V1Prometheus;

  constructor(resource: V1Prometheus, kubeConfig: KubeConfig) {
    super(resource, kubeConfig);

    this.resource = resource;
    this.api = kubeConfig.makeApiClient(V1PrometheusApi);
  }
  get spec(): V1Prometheus {
  ...
  static startInformer(
    ...
    const watch = async () => {
      ...
      try {
        ...
        channel(V1PrometheusActions.fetch.failure({ error }));
