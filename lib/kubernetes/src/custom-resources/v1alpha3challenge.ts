...
export class V1Alpha3ChallengeApi {
  ...
  public setApiKey(key: V1Alpha3ChallengeApiApiKeys, value: string) {
    (this.authentications as any)[
      V1Alpha3ChallengeApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async createNamespacedV1Alpha3Challenge(
    namespace: string,
  ...
  ): Promise<{ response: IncomingMessage; body: V1Alpha3Challenge }> {
    const localVarPath =
      this.basePath +
      "/apis/acme.cert-manager.io/v1alpha3/namespaces/{namespace}/challenges".replace(
        "{" + "namespace" + "}",
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling createNamespacedV1Alpha3Challenge."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling createNamespacedV1Alpha3Challenge."
      );
    }
   ...
   */
  public async readNamespacedV1Alpha3Challenge(
    name: string,
    namespace: string,
    pretty?: string,
    exact?: boolean,
    ...
    const localVarPath =
      this.basePath +
      "/apis/acme.cert-manager.io/v1alpha3/namespaces/{namespace}/challenges/{name}"
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling readNamespacedV1Alpha3Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling readNamespacedV1Alpha3Challenge."
      );
    }
   ...
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
   */
  public async patchNamespacedV1Alpha3Challenge(
    name: string,
    namespace: string,
    body: object,
    pretty?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling patchNamespacedV1Alpha3Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling patchNamespacedV1Alpha3Challenge."
      );
    }
    ...
    if (body === null || body === undefined) {
      throw new Error(
        "Required parameter body was null or undefined when calling patchNamespacedV1Alpha3Challenge."
      );
    }
   ...
   * @param body
   */
  public async deleteNamespacedV1Alpha3Challenge(
    name: string,
    namespace: string,
    pretty?: string,
    dryRun?: string,
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling deleteNamespacedV1Alpha3Challenge."
      );
    }
    ...
    if (namespace === null || namespace === undefined) {
      throw new Error(
        "Required parameter namespace was null or undefined when calling deleteNamespacedV1Alpha3Challenge."
      );
    }
   ...
   */
  public async listV1Alpha3ChallengeForAllNamespaces(
    ...
    watch?: boolean,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: IncomingMessage; body: V1Alpha3ChallengeList }> {
    const localVarPath =
      this.basePath + "/apis/acme.cert-manager.io/v1alpha3/challenges";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this.defaultHeaders
...
export const isV1Alpha3ChallengeResource = <
  (r: K8sResource) => r is V1Alpha3ChallengeResourceType
...
export const V1Alpha3ChallengeActions = {
  ...
  onUpdated: createAction(
    "ON_UPDATED_K8S_V1ALPHA3CHALLENGE"
  )<V1Alpha3ChallengeResourceType>(),
  onAdded: createAction(
    "ON_ADDED_K8S_V1ALPHA3CHALLENGE"
  )<V1Alpha3ChallengeResourceType>(),
  onDestroyed: createAction(
    "ON_DESTROYED_K8S_V1ALPHA3CHALLENGE"
  )<V1Alpha3ChallengeResourceType>()
};
export type V1Alpha3ChallengeResourceActions = ActionType<
  typeof V1Alpha3ChallengeActions
>;
export interface V1Alpha3ChallengeResourceState
  extends ResourceCache<V1Alpha3ChallengeResourceType> {}
...
export class V1Alpha3ChallengeResource extends K8sResource {
    ...
    const watch = async () => {
        ...
        channel(
          V1Alpha3ChallengeActions.fetch.success({
            resources: res.body.items.map(
              r => new V1Alpha3ChallengeResource(r, kubeConfig)
            )
          })
        );
      } catch (error) {
      ...
      const watchHandler = (phase: string, obj: V1Alpha3Challenge) => {
        switch (phase) {
          case "ADDED":
            channel(
              V1Alpha3ChallengeActions.onAdded(
                new V1Alpha3ChallengeResource(obj, kubeConfig)
              )
            );
            break;
          case "MODIFIED":
            channel(
              V1Alpha3ChallengeActions.onUpdated(
                new V1Alpha3ChallengeResource(obj, kubeConfig)
              )
            );
            break;
  ...
  create(): Promise<{
    ...
    return this.api.createNamespacedV1Alpha3Challenge(
      this.namespace,
      this.resource
    );
  }
  ...
  delete(): Promise<{
    ...
    return this.api.deleteNamespacedV1Alpha3Challenge(
      this.name,
      this.namespace
    );
  }
