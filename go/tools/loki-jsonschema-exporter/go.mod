module github.com/opstrace/go/tools/loki-jsonschema-exporter
...
require (
	...
	github.com/cortexproject/cortex v1.9.0-rc.0
	...
	//
	// Loki does not support golang modules properly:
	// https://github.com/grafana/loki/issues/2826
	// We need to pin to specific commits with:
	// go get github.com/grafana/loki@COMMIT_HASH
	//
	github.com/grafana/loki v1.6.2-0.20210503121652-aa544a9dffdb // indirect
