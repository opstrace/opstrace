...
import Status from "client/integrations/plugins/syntheticMonitoring/Status";
...
const SyntheticMonitoringShow = (props: IntegrationProps) => {
...
const showSections = [{ label: "Detail", Component: SyntheticMonitoringShow }];
