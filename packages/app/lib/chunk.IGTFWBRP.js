...
var Row = (props) => {
  ...
  if (Array.isArray(children)) {
    children = children.map((c, idx) => {
      if (React2.isValidElement(c)) {
        if (c.type !== Column_default) {
          return /* @__PURE__ */ React2.createElement(Column_default, {
            key: idx,
            minHeight: props.minHeight
          }, c);
        }
        return React2.cloneElement(c, {
          minHeight: props.minHeight,
          key: idx
        });
      }
  ...
  } else if (React2.isValidElement(children)) {
    children = React2.Children.map(children, (c, idx) => {
      if (c.type !== Column_default) {
        return /* @__PURE__ */ React2.createElement(Column_default, {
          key: idx,
          minHeight: props.minHeight
    ...
    children = /* @__PURE__ */ React2.createElement(Column_default, {
      minHeight: props.minHeight
    }, children);
  }
...
var Row_default = Row;
function row(child) {
  return /* @__PURE__ */ React2.createElement(Row, null, child);
}
...
var Panel = (props) => {
  let children = props.children;
  const theme = Xe();
  console.log("theme", theme?.palette, "sandbox");
  if (Array.isArray(children)) {
    children = children.map((c, idx) => {
...
var Column = (props) => {
  ...
  if (Array.isArray(children)) {
    ...
    children.forEach((c, idx) => {
      if (React4.isValidElement(c)) {
        if (c.type === Column || c.type === Row_default) {
          hasLayoutComponentChild = true;
        }
      }
    });
    if (hasLayoutComponentChild) {
      children = children.map((c, idx) => {
        if (React4.isValidElement(c)) {
          if (c.type !== Column) {
            return /* @__PURE__ */ React4.createElement(Column, {
              key: idx,
              minHeight: props.minHeight
            }, c);
          }
  ...
  } else if (React4.isValidElement(children)) {
    let hasLayoutComponentChild = false;
...
function column(child) {
  return /* @__PURE__ */ React4.createElement(Column, null, child);
}
...
//# sourceMappingURL=chunk.W3ZJYOU4.js.map
