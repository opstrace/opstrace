...
// src/client/components/Box/Box.tsx
...
// src/client/components/Box/Box.tsx
var Box2 = (props) => /* @__PURE__ */ React2.createElement(Box_default, {
  ...props
});
...
`;
var Row = (props) => {
  let children = React3.Children.map(props.children, (c, idx) => {
    if (c.type !== Column_default) {
      return /* @__PURE__ */ React3.createElement(Column_default, {
        key: idx,
  ...
  return /* @__PURE__ */ React3.createElement(Wrapper, {
    style: {
...
// src/client/components/Layout/Panel.tsx
var PanelWrapper = styled5(Box_default)`
  border-radius: 2px;
  overflow: hidden;
...
var Panel = (props) => {
  ...
  }, /* @__PURE__ */ React4.createElement(PanelWrapper, {
    p: 1
  }, children));
};
...
var Column = (props) => {
  ...
  }, /* @__PURE__ */ React5.createElement(Panel_default, {
    minHeight: props.minHeight
  }, children));
};
...
import React6, {useCallback, useEffect, useRef, useState} from "https://cdn.skypack.dev/react";
import styled6 from "https://cdn.skypack.dev/styled-components";
var Wrapper2 = styled6.div((props) => ({
  display: "flex",
  flexDirection: "column",
  flexGrow: 1,
  flexWrap: "wrap"
}));
var AutoSizedLayout = (props) => /* @__PURE__ */ React6.createElement(Box_default2, {
  width: "100%",
  height: "100%",
  className: "Layout"
}, /* @__PURE__ */ React6.createElement(index_esm_default, {
  style: {width: "100%", height: "100%"}
}, ({width: width2, height: height2}) => /* @__PURE__ */ React6.createElement(Box_default2, {
  width: "100%",
  height: "100%"
}, /* @__PURE__ */ React6.createElement(Scrollable_default, null, /* @__PURE__ */ React6.createElement(Box_default2, {
  p: 0,
  justifyContent: "left",
  alignItems: "normal"
}, /* @__PURE__ */ React6.createElement(Layout, {
  minHeight: height2,
  width: width2
}, props.children))))));
var Layout = (props) => {
  const childrenCount = React6.Children.count(props.children);
  const nodeRef = useRef(null);
  const roughChildHeight = () => props.minHeight / childrenCount < MIN_ITEM_HEIGHT ? MIN_ITEM_HEIGHT : props.minHeight / childrenCount;
  ...
  useEffect(() => {
    const calculateHeight = () => {
      ...
      if (node.clientHeight > props.minHeight) {
        ...
        setMinChildHeight(newHeight < MIN_ITEM_HEIGHT ? MIN_ITEM_HEIGHT : Math.round(newHeight));
      } else {
  ...
  return /* @__PURE__ */ React6.createElement(Wrapper2, {
    ref: layoutRef,
    className: "RowWrapper"
  }, React6.Children.map(props.children, (child, idx) => {
    if (child.type !== Row_default) {
      return /* @__PURE__ */ React6.createElement(Row_default, {
        key: idx,
        minHeight: props.minHeight
      }, child);
    }
    return React6.cloneElement(child, {minHeight: minChildHeight});
  }));
};
var Layout_default = AutoSizedLayout;
...
//# sourceMappingURL=chunk.KHFPC6SF.js.map
