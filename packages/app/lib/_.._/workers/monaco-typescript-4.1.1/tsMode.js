...
// src/workers/monaco-typescript-4.1.1/workerManager.ts
"use strict";
  ...
  _getClient() {
    if (!this._client) {
      ...
      if (this._defaults.getEagerModelSync()) {
        p = p.then((worker) => {
          if (this._worker) {
            return this._worker.withSyncedResources(editor.getModels().filter((model) => model.getModeId() === this._modeId).map((model) => model.uri));
          }
          return worker;
        });
      }
...
// src/workers/monaco-typescript-4.1.1/lib/lib.index.ts
var libFileSet = {};
...
// src/workers/monaco-typescript-4.1.1/languageFeatures.ts
"use strict";
var IndentStyle;
...
// src/workers/monaco-typescript-4.1.1/tsMode.ts
"use strict";
