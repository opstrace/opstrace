...
For linting our documentation, we use [Markdownlint](/docs/contributing/writing-docs#get-on-your-marks), with rules defined in `.markdownlint.json` in the project root.
